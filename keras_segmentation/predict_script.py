...
model.train(
    train_images =  "/SCDD-image-segmentation-keras/share/dataset1/images_prepped_train",
    train_annotations = "/SCDD-image-segmentation-keras/share/dataset1/annotations_prepped_train",
